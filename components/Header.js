...
export default function Layout() {
  ...
  return (
    <>
      <Head>
        <title>MangoAds Nextjs</title>
        <meta name="description" content="Generated by create next app" />
        <link
          rel="icon"
          type="image/png"
          sizes="16x16"
          href="https://mangoads.vn/vn/wp-content/themes/wp-th/assets/images/favicon.svg"
        />
        <link
                  ...
                  <Link href="/">
                    <a className="w-logo-link">
                      <img
                        ...
                        src="https://mangoads.vn/vn/wp-content/themes/wp-th/assets/images/Logo-MangoAds.png"
                        alt="MangoAds"
                      />
                    </a>
                  </Link>
              ...
              <Link href="/">
                <a className="logo1" alt="Eng">
                  <span className="w-nav-title">
                    <img
                      src="https://mangoads.vn/vn/wp-content/plugins/qtranslate-xt-master/flags/gb.png"
                      alt="Eng"
                    />
                  </span>
                </a>
