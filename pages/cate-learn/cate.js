...
export default function MangoAdsLearn({children}) {
  var posts = [{
    ...
    url:'/post/post-id',
    img:'https://mangoads.vn/learn/wp-content/uploads/2021/10/Cach-toi-uu-trai-nghiem-quang-cao-voi-khach-hang-Mu-bieu-ngu-01-680x510-1.jpg',
    title:'Cách tối ưu trải nghiệm quảng cáo với khách hàng Mù biểu ngữ',
    cate: 'Website development',
    date:'October 25, 2021',
    author:'Đoàn Tịnh',
  },{
    url:'/post/post-id',
    img:'https://mangoads.vn/learn/wp-content/uploads/2021/10/166-680x510-1.png',
    title:'30 ý tưởng tạo social marketing content cho thương hiệu',
    cate: 'Content marketing',
    date:'October 25, 2021',
    author:'Hạnh Trần',
  },{
    url:'/post/post-id',
