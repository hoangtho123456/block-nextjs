jQuery(document).ready(function () {
  ...
  window.resizeHandler = function () {
    ...
    if (
      body.hasClass("no_pagesections") &&
      firstSection.find(".us_supersized").length
    ) {
      fullScreenHome = true;
    ...
    var linkScroll = function (event, link) {
      ...
      jQuery("html, body").animate(
        {
          scrollTop:
            jQuery(link.hash).offset().top - scrollOffsetTolerance + "px",
        },
        {
          duration: 800 /*,
    ...
    jQuery('a[class="w-logo-link"][href="#"]')
      .off("click")
    ...
    if (jQuery("body").hasClass("home"))
      jQuery('a[href^="#"][href!="#"]')./*off('click').die('click').live*/ on(
        "click",
        function (event) {
          event.preventDefault();
    ...
    jQuery(".l-header .w-nav").each(function () {
      var nav = jQuery(this),
        ...
        navSubLists2 = navList.find(".w-nav-list-h .children .sub-menu"),
      ...
      if (W <= mobileNavWidth) {
        ...
        var btnShowNavSub = navList.find(".children .w-nav-hint");
        //end
        ...
        if (!nav.hasClass("touch_enabled")) {
          ...
          navSubLists2.css({ display: "none" });
          // navSubLists.addClass('hide-menu');
          // navSubLists2.addClass('hide-menu');
        }
        ...
        //tho
        btnShowNavSub.off("click").click(function () {
          if (!navRunning) {
            navRunning = true;
            var subList = jQuery(this)
                .closest(".children")
        ...
        navSubLists2.css({ height: "", display: "" });
    ...
    var scrollTimer = false,
      scrollHandler = function () {
        ...
        if (
          body.hasClass("headertype_sticky") &&
          (body.hasClass("headerpos_bottom") ||
            body.hasClass("headerpos_outside"))
        ) {
